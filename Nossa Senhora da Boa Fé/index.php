        ...
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                    <img src="Imagens/JardimExterior.jpeg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/igreja.jpg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/igrejacomcruz.jpg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/Entrada.jpg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/interiorigreja.jpg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/SalaDeRefeicao.jpeg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/Quarto.jpeg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/Quarto2.jpeg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="Imagens/CasaDeBanho.jpeg" class="ImagensCar" class="d-block w-100" alt="Imagem não encontrada">
                </div>
            </div>
